...
const DEFAULT_HTML_FORM_TEMPLATE = `<form class="space-y-4">
  <div>
  ...
  <button type="submit" class="w-full bg-orange-500 text-white font-bold py-4 rounded-xl shadow-lg mt-2">COMPLETA L'ORDINE</button>
</form>`;
